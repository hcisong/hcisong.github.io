...
var treemap = d3.layout.treemap()
	...
	/* create svg */
var svg_tree = d3.select("#chart").append("svg")
...
var grandparent = svg_tree.append("g")
...
/* create grandparent bar at top */
	...
	var g1 = svg_tree.insert("g", ".grandparent")
		.datum(d)
		.attr("class", "depth");
		/* add in data */
	...
	function transition(d) {
		...
		svg_tree.style("shape-rendering", null);

		// Draw child nodes on top of parent nodes.
		svg_tree.selectAll(".depth").sort(function(a, b) { return a.depth - b.depth; });
		...
		t1.remove().each("end", function() {
			svg_tree.style("shape-rendering", "crispEdges");
			transitioning = false;
		});
